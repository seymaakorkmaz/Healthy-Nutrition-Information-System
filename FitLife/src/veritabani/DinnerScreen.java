...
public class DinnerScreen extends JFrame {
	...
	public DinnerScreen(Client client,int gender, int activity, int aim, int age, int height, int weight ,double topCalorie, double topCarb, double topFat, double topProtein) throws Exception {
		setIconImage(Toolkit.getDefaultToolkit().getImage(DinnerScreen.class.getResource("/icons/apple.png")));
		setTitle("FitLife");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					SnackScreen screen = new SnackScreen(client,gender, activity, aim, age, height, weight,top1,top2,top3,top4);
		...
		JLabel lblKahvalt = new JLabel("DINNER");
		lblKahvalt.setIcon(new ImageIcon(DinnerScreen.class.getResource("/icons/meal.png")));
