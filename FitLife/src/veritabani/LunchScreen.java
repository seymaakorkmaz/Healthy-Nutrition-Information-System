...
public class LunchScreen extends JFrame {
	...
	public LunchScreen(Client client, int gender, int activity, int aim, int age, int height, int weight, double topCalorie, double topCarb, double topFat, double topProtein) throws Exception {
		setIconImage(Toolkit.getDefaultToolkit().getImage(LunchScreen.class.getResource("/icons/apple.png")));
		setTitle("FitLife");
		...
		System.out.println(database.loggedUser().getAge());
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(flag==0) {
					...
					try {
						DinnerScreen dinner = new DinnerScreen(client,gender, activity, aim, age, height, weight,top1,top2,top3,top4);
		...
		JLabel lblKahvalt = new JLabel("LUNCH");
		lblKahvalt.setIcon(new ImageIcon(LunchScreen.class.getResource("/icons/lunch.png")));
